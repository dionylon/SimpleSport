...
import com.dionys.mymap.util.TraceRePlay;
...
public class RecordShowActivity extends AppCompatActivity
        implements AMap.OnMapLoadedListener, TraceListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detailText = findViewById(R.id.record_info);
...
//        hideUI();
    ...
    private void hideUI() {
        mDisplaybtn.setVisibility(View.INVISIBLE);
        mGraspRadioButton.setVisibility(View.INVISIBLE);
        mOriginRadioButton.setVisibility(View.INVISIBLE);
    ...
    private void init() {
        ...
        detailText.setText(getRecord().details());
    }
    ...
    private void setupRecord() {
        ...
        if (mRecord != null) {
            ...
            LatLng endLatLng = new LatLng(endLoc.getLatitude(),
                    endLoc.getLongitude());
            mOriginLatLngList = LocUtil.parseLatLngList(recordList);
            addOriginTrace(startLatLng, endLatLng, mOriginLatLngList);

            List<TraceLocation> mGraspTraceLocationList = LocUtil
